...
df = pd.read_csv("https://media.githubusercontent.com/media/alialoulou96/test2/master/id_information_mmsr.tsv", delimiter='\t')
...
# text data
df_bert = pd.read_csv("https://media.githubusercontent.com/media/alialoulou96/test2/master/id_lyrics_bert_mmsr.tsv", delimiter='\t')
# audio_data
...
df_musicnn = pd.read_csv("https://media.githubusercontent.com/media/alialoulou96/test2/master/id_musicnn_mmsr.tsv", delimiter='\t')

# url info
url_df = pd.read_csv("https://media.githubusercontent.com/media/alialoulou96/test2/master/id_url_mmsr.tsv", delimiter='\t')
# genres
genre =  pd.read_csv("https://media.githubusercontent.com/media/alialoulou96/test2/master/id_genres_mmsr.tsv", delimiter='\t')
